  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      title:Padding(
          ...
          child: Row(
            children: [
          Text("Portfolio",style: GoogleFonts.poppins (fontSize: 18,fontWeight: FontWeight.w400,color: Colors.white),),
          const Spacer(),
           HeaderButton(text: 'Home', onPressed: () { 
              controller.animateTo(200, duration:  const Duration(milliseconds: 200), curve: Curves.bounceIn);
             },),
      ...
      body:    SingleChildScrollView(
        padding: EdgeInsets.only(top: size.height *0.15, right:size.height *0.15 ,left:size.height *0.15  ),
